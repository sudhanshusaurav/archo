...
function AboutUs() {
  ...
  return <div className='w-full py-32 overflow-x-hidden'>
      <div className='w-[85%] mx-auto about about__tl__init'>
          <div className='flex flex-col items-center justify-between gap-12 lg:gap-0 lg:flex-row'>
              ...
              <div className='relative flex-1 lg:pl-20'>
                ...
                <h1 className='my-4 text-5xl font-normal tracking-normal md:my-8 font-playfair about__fade__in'>Best Designers <br /> Architectures for You.</h1>
                ...
                <div className='flex items-center mt-12'>
                    <div className='flex-1 px-4 md:px-8 about__fade__in'>
                ...
                <div className='absolute top-0 hidden md:block right-0 w-1/3 h-1/2 z-[-1] border-8 border-gray/5 el__parallax__frame about__slide__left'></div>
              </div>
          </div>
      </div>
  </div>;
